...
import { BsPhone , BsPerson , BsGeoAlt , BsCalendar } from 'react-icons/bs';
...
export default function DonerProfile() {
  ...
  return (
    <>
      ...
      <Box
        ...
        >
          <VStack spacing={{ base: 4, md: 5, lg: 20 }}>
                ...
                <VStack spacing={5}>
                  {details.map((detail) => (
                      ...
                      <FormControl isRequired>
                        <FormLabel>{detail.field1}</FormLabel>
  
                        <InputGroup>
                          <InputLeftElement children={detail.icon1} />
                          <Input type="text" name="name" placeholder="Your Name" />
                        </InputGroup>
                      </FormControl>
  
                      <FormControl isRequired>
                        <FormLabel>{detail.field2}</FormLabel>
  
                        <InputGroup>
                          <InputLeftElement children={detail.icon2} />
                          <Input type="text" name="name" placeholder="Your Name" />
                        </InputGroup>
                      </FormControl>
                    </HStack>
